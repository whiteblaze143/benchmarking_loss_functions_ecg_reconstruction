...
from src.reconstruction.unified_latents.engineering.vae_fm import weighted_reconstruction_mse


_ALITOK_ROOT = Path("/home/mithunmanivannan/third_party/alitok/alitok-main")
    ...
    def __init__(
        ...
        *,
        ...
        if teacher_encoder:
            ...
            self.teacher_token_projs = None
            self.teacher_layer_logits = None
        self.causal_decoder = AliTokECGCausalDecoder(
            target_len=target_len,
            patch_size=patch_size,
            token_size=token_size,
            aux_tokens_num=aux_tokens_num,
        ...
        self.bidir_decoder = AliTokECGBidirectionalDecoder(
            target_len=target_len,
            patch_size=patch_size,
            token_size=token_size,
            aux_tokens_num=aux_tokens_num,
