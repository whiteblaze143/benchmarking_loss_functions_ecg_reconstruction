...
Freeze the selected ECG-AIM checkpoint. Train only the auxiliary branch on the training split. Select hyperparameters on validation. Evaluate once on the untouched test split.
