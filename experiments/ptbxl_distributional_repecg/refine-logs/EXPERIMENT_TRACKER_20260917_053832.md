...
|---|---|---|---|---|---|---|
| R001 | M0 | strict smoke training | 15 papers, 52 variants, 9 cells each | MUST | DONE | 468 exact selection-cell rows |
| R002 | M0 | aggregation/reload evaluation | all 52 variants | MUST | DONE | 52 checkpoint-backed evaluations |
| R003 | M0 | database reconciliation | smoke cells/evaluations | MUST | DONE | 52 complete, zero pending/failed; 10,920 metric rows |
