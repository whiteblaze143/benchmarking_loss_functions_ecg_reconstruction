...
## 3. The 33-Cell Ablation Matrix

To definitively prove Occam's Razor across all architectural and biophysical dimensions, we execute a 33-cell factorial study:
...
- **Claim 3 (Loss Coherence)**: The clean triplet loss avoids the $-0.013$ collapse induced by higher-order MMD/VCG objective competition.
