...
class WearECGFMVAE(nn.Module):
    ...
    def __init__(
        ...
        if self.fm_teacher_encoder == "ecgfm":
            ...
            from unified_latents.engineering.experimental.token_refiner import build_token_teacher
    ...
    def _extract_fm_layers(self, x_12: torch.Tensor) -> List[torch.Tensor]:
        ...
        from unified_latents.engineering.experimental.token_refiner import align_token_length
