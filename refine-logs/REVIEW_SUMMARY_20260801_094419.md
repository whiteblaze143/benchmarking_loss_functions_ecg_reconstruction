...
- Can the final cached-target evaluator keep pace with training beyond its current 4/18 accepted compatible checkpoints while preserving paired beat/failure denominators?
