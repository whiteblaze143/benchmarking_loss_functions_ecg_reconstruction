...
| SD021 | Upstream | Exact-Theta architecture factorial | Exact released `ThetaEncoder`; complete L×R×F `2^3`; `1010010`/`1000000`; Lead I/II; seed 42 | PTB-XL validation | Cell means, L/R/F main effects and interactions, source/mask heterogeneity | MUST | QUEUED | 32 jobs; combined queue total 56; no fixed 0.1 gains; grouped-vs-exact is secondary because feature sets differ only by permutation |
