...
| E001 | M1 | simple learned baseline | ECG-AIM A0 `1000000_s42` | train/val/test, 2,398 | activation contract | MUST | RUNNING | tmux `checkpoint_embedding_rdb`, CPU 7 only |
...
| E200 | M4 | live book integration | compact SQLite reader | complete + partial jobs | tables/plots/provenance | MUST | COMPLETE-LIVE | chapter renders and displays partial state |
