...
- Does the evaluator continue to keep pace beyond its current 7/20 accepted compatible checkpoints? At the present medians it is faster than training and projects to drain the 13-model backlog in about 21.9 hours, but this must be rechecked if model mix, contention, or evaluator generation changes.
