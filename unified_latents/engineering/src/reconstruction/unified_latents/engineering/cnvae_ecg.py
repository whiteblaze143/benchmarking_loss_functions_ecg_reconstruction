...
def _setup_fairseq_path():
    ...
    # Current file: src/reconstruction/unified_latents/engineering/cnvae_ecg.py
    # Project root is 5 levels up from here:
    # engineering -> unified_latents -> reconstruction -> src -> repo root
