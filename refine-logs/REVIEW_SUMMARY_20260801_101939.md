...
- Does the evaluator continue to keep pace beyond its current 6/19 accepted compatible checkpoints? At the present medians it is faster than training and projects to drain the backlog in about 24.6 hours, but this must be rechecked if model mix, contention, or evaluator generation changes.
