...
def main():
    ...
    if args.batch_size == 256 and args.architecture == "msvae":
        args.batch_size = 32
    elif args.batch_size == 256 and args.architecture == "ecg_aim":
        args.batch_size = 64
    ...
    for epoch in range(args.epochs):
        ...
        use_amp = (args.architecture in {"unet", "ecg_aim"})
        amp_dtype = torch.bfloat16 if args.architecture == "ecg_aim" else torch.float16
