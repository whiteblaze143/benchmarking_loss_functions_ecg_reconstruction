...
DEFAULT_ECGFM_CKPT = str(Path(__file__).resolve().parents[3] / "ecg_fm_integration" / "checkpoints" / "mimic_iv_ecg_physionet_pretrained.pt")
DEFAULT_HUBERT_MODEL = "Edoardo-BS/HuBERT-ECG-SSL-Pretrained"
HUBERT_REPO_CODE = str(Path(__file__).resolve().parents[3] / "ecg_fm_integration" / "hubert_ecg_repo" / "code")
