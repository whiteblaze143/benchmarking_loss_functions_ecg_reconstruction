...
from unified_latents.engineering.models.vae_fm import WearECGVAE, WearECGFMVAE
...
def lightweight_validate(
    ...
    missing_names = [
        lead for index, lead in enumerate(lead_names) if index not in args.obs_lead_indices
    ]
    metrics["val/missing_mse_reg"] = _mean_for(missing_names, lead_mse)
    metrics["val/missing_mae_reg"] = _mean_for(missing_names, lead_mae)
    metrics["val/missing_rmse_reg"] = _mean_for(missing_names, lead_rmse)
    metrics["val/missing_corr_reg"] = _mean_for(missing_names, lead_corr)
