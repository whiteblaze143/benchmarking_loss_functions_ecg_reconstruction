...
output=$repo/experiments/ptbxl_distributional_repecg/outputs/paper13_counterfactual_surgery
...
"$python" "$repo/experiments/ptbxl_distributional_repecg/scripts/paper13/aggregate_paper13_grid.py" \
    --cells "$output/cells" \
    --output "$output" \
    --seed 42
