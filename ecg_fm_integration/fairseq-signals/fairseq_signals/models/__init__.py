    ...
    for file in os.listdir(models_dir):
        ...
        if (
            ...
            try:
                ...
                # Some optional model families depend on older third-party
                # APIs. Skip them so ECG-FM's ecg_transformer can still load.
                if model_name == "ecg_transformer":
                    raise
                print(f"[fairseq_signals] Skipping optional model {model_name}: {exc}")
                continue
