...
$$
r_j\in\mathbb R^{16\times128}\longmapsto e_{r,j}\in\mathbb R^{128}
$$
...
$$
\tilde H \longrightarrow u\in\mathbb R^{192} \longrightarrow z=\operatorname{GELU}(W_zu+b_z)\in\mathbb R^{256}
$$
...
$$
\ell=W_{\mathrm{diag}}z+b_{\mathrm{diag}}\in\mathbb R^5, \qquad \hat p=\sigma(\ell)
$$
